...
IGNORED_PREFIXES=(".git" ".github" "nginx" "scripts" "Dockerfile" ".dockerignore" "DEPLOY.md" "MOC.md" "ROADMAP.md" ".gitignore" "docs" "spike" "generator" "tools" "imaging" "web-component" "Makefile" "service" "issuer-service" ".env.example" "LICENSE" "CONTRIBUTING.md" "CODE_OF_CONDUCT.md" "CONCEPTS.md")

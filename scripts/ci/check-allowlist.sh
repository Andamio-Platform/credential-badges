...
ALLOWED=("context" "issuer" "badges" "status" ".well-known" "public" "embed" "README.md")

# Repo paths that exist for tooling/build and are never served — ignore them.
IGNORED_PREFIXES=(".git" ".github" "nginx" "scripts" "Dockerfile" ".dockerignore" "DEPLOY.md" "MOC.md" "ROADMAP.md" ".gitignore" "docs" "signing" "archive" "generator" "tools" "imaging" "web-component" "Makefile" "service" "issuer-service" ".env.example" "LICENSE" "CONTRIBUTING.md" "CODE_OF_CONDUCT.md" "CONCEPTS.md" "AGENTS.md")

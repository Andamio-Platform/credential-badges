...
<meta name="description" content="A holder's Andamio credential badges with live verified and suspended state — verifiable independently, without trusting {ISSUER}.">
...
<p class="lead">A live view of one holder's Andamio credential badges — each shown
   with its current on-chain and suspension state, verifiable independently.</p>
...
<p class="note"><strong>Status.</strong> This viewer confirms the on-chain anchor
   and the suspension state directly in your browser. It does not itself assert a
   signature is cryptographically valid — for that, check a signed badge with an
   independent verifier as described in the
